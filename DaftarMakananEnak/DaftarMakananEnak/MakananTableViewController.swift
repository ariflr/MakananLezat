...
class MakananTableViewController: UITableViewController {
    ...
    let category:[String] = ["Pecel Bajo","Indomie","Pecel","gado-gado","lontong"]
    
    let gambarBerita = ["bajo","indomie","Nasi_Pechuel","gado-gado","lontong"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.Nama.text = category[indexPath.row]
